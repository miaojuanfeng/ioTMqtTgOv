            ...
            <div class="row">
                <div class="col-md-12">
                    <form role="form" class="form-horizontal krt-form krt-width-form" id="krtForm">
                                            ...
                                            <select class="form-control" id="province"
                                                ...
                                                <#list provinces as province>
                                                    <option value="${province.id!}"
                                                            <#if "#{((user.area!)?number/10000)?int}"=="${province.code!}">selected</#if> >${province.name!}</option>
                                                </#list>
                                            </select>
                                        </div>
                                    </div>
                                            ...
                                            <select class="form-control" id="city"
                                                ...
                                                <#list cities as city>
                                                    <option value="${city.id!}"
                                                            <#if "#{((user.area!)?number/100)?int}"=="${city.code!}">selected</#if> >${city.name!}</option>
                                                </#list>
                                            </select>
                                        </div>
                                    </div>
                                            ...
                                            <select class="form-control" id="region">
                                                ...
                                                <#list regions as region>
                                                    <option value="${region.id!}"
                                                            code="${region.code!}"
                                                            <#if "${user.area!}"=="${region.code!}">selected</#if> >${region.name!}</option>
                                                </#list>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <!-- 参数 -->
                        <input type="hidden" name="area" id="area" value="${user.area!}">
