                    ...
                    <form role="form" class="form-horizontal krt-form krt-width-form" id="krtForm">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <!-- 参数 -->
                                            <input type="hidden" name="pid" id="pid" value="${(pRes.id)!}"
                                                   class="form-control">
                                            <div class="input-group">
                                                <input type="text" name="pname" value="${(pRes.name)!}" id="pname"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="name" id="name" value="${(res.name)!}"
                                                   class="form-control" rangelength="1,50" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="radio" name="type" value="url" class="icheck"
                                                   checked="checked"> 菜单
                                            <input type="radio" name="type" value="button" class="icheck"> 按钮
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="target" id="target" class="form-control select2"
                                                ...
                                                <option value="_blank">新tab页</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="remark" class="control-label col-sm-2">目标：</label>
                                        <div class="col-sm-10">
