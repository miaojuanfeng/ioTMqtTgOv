                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="groupName" id="groupName" class="form-control" placeholder="请输入组名" required maxlength="10">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="name" id="name" class="form-control" placeholder="请输入任务名" required maxlength="10">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="text" name="expression" id="expression" placeholder="请输入cron表达式" class="form-control" readonly required>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="sort" class="control-label col-sm-4">
                                            ...
                                            ：</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="springId" id="springId" placeholder="请输入springId" class="form-control" required>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="method" id="method" placeholder="请输入方法名" class="form-control" required>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea rows="4" name="description" class="form-control" placeholder="请输入描述" maxlength="200"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
