                        ...
                        <div class="box-body">
                            ...
                            <#--<div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="radio" name="isHoliday" value="1"
                                               class="icheck" ${deviceStrategy.isHoliday!?contains("1")?string("checked", "")}>
                                        节假日+工作日
                                        <input type="radio" name="isHoliday" value="2"
                                               class="icheck" ${deviceStrategy.isHoliday!?contains("2")?string("checked", "")}>
                                        仅工作日
                                        <input type="radio" name="isHoliday" value="3"
                                               class="icheck" ${deviceStrategy.isHoliday!?contains("3")?string("checked", "")}>
                                        仅节假日
                                    </div>
                                </div>
                            </div>-->
                                    ...
                                    <div class="col-sm-12">
                                        <table id="conditiontable" class="table table-bordered table-hover">
                                            ...
                                            <#list deviceStrategyRequireList as deviceStrategyRequire>
                                                <tr>
                                                    <td>${deviceStrategyRequire.deviceId!}</td>
                                                    <td>${deviceStrategyRequire.deviceName!}</td>
                                                    <td>${deviceStrategyRequire.requiresDetails!}</td>
                                                    <td>
                                                        <a class="btn btn-xs btn-warning updateConditionBtn"
                                                           rid="${deviceStrategyRequire.deviceId!}">
                                                    ...
                                                    <input type="hidden" class="cdeviceId"
                                                           value="${deviceStrategyRequire.deviceId!}"/>
                                                    <input type="hidden" class="cdeviceName"
                                                           value="${deviceStrategyRequire.deviceName!}"/>
                                                    <input type="hidden" class="condition"
                                                           value='${deviceStrategyRequire.requires!}'/>
                                                    <#--<input type="hidden" class="condition" value='${deviceStrategyRequire.tempMax!}'/>
                                                    <input type="hidden" class="condition" value='${deviceStrategyRequire.tempMin!}'/>
                                                    <input type="hidden" class="condition" value='${deviceStrategyRequire.humiMax!}'/>
                                                    <input type="hidden" class="condition" value='${deviceStrategyRequire.humiMin!}'/>-->
                                                    <input type="hidden" class="conditionDetails"
                                                           value="${deviceStrategyRequire.requiresDetails!}"/>
                                                </tr>
                                            </#list>
                                        </table>
                                        ...
                                        <table id="datatable" class="table table-bordered table-hover">
                                            ...
                                            <#list deviceStrategyLinkList as deviceStrategyLink>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-xs btn-warning updateBtn"
                                                           rid="${deviceStrategyLink.deviceId!}">
                                                    ...
                                                    <input type="hidden" class="deviceId"
                                                           value="${deviceStrategyLink.deviceId!}"/>
                                                    <input type="hidden" class="deviceName"
                                                           value="${deviceStrategyLink.deviceName!}"/>
                                                    <input type="hidden" class="action"
                                                           value='${deviceStrategyLink.action!}'/>
                                                    <input type="hidden" class="actionDetails"
                                                           value="${deviceStrategyLink.actionDetails!}"/>
                                                </tr>
                                            </#list>
                                            <#--<tr>-->
                                            <#--<td>1</td>-->
                                            ...
                                            <#--<td></td>-->
                                            <#--<td>-->
                                            <#--<button class="btn btn-xs btn-warning updateBtn" rid="1">-->
                                            <#--<i class="fa fa-edit fa-btn"></i>操作-->
                                            <#--</button>-->
