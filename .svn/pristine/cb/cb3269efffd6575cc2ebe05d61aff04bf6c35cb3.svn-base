                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="warningDetails" name="tempL"
                                               class="form-control" value="${govDevWarn.tempL!}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="warningDetails" name="tempH"
                                               class="form-control" value="${govDevWarn.tempH!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="warningDetails" name="humiL"
                                               class="form-control" value="${govDevWarn.humiL!}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="warningDetails" name="humiH"
                                               class="form-control" value="${govDevWarn.humiH!}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <table id="deviceTable" class="table table-bordered"
                                    ...
                                    <#list deviceJsonArr as deviceJson>
                                        <tr id='device${deviceJson.deviceId!}'>
                                            ...
                                            <td>
                                                <button class='btn btn-xs btn-danger deviceDeleteBtn'
                                                        rid='${deviceJson.deviceId!}'><i
                                                            class='fa fa-trash fa-btn'></i>删除
                                                </button>
                                            </td>
                                            <input type="hidden" class='deviceId' value='${deviceJson.deviceId!}'>
                                            <input type="hidden" class='deviceName' value='${deviceJson.deviceName!}'>
                                        </tr>
                                    </#list>
                                </table>
                            </div>
                                        ...
                                        <tr id="${govTime_index}">
                                            ...
                                            <td>
                                                <button class='btn btn-xs btn-danger'
                                                        onclick="timeDelBtn(this)"><i
                                                            class='fa fa-trash fa-btn'></i>删除
                                                </button>
                                            </td>
                                            <input type="hidden" class='sTime' value='${govTime.sTime!}'>
                                            <input type="hidden" class='fTime' value='${govTime.fTime!}'>
                                        </tr>
                                    </#list>
                                </table>
                            </div>
