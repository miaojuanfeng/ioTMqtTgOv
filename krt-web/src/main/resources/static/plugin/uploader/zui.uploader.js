...
(function ($, window, Plupload, Moxie, undefined) {
	...
	Uploader.prototype.showMessage = function (message, type, time) {
		...
		var $content = $msg.find('.krt-up-content');
...
(function ($, grobal) {
	$.fn.krtUploader = function (options) {
		...
		var htmls = {
			...
			'simple': '<div class="uploader-message text-center"><div class="krt-up-content"></div><button type="button" class="close">×</button></div><div class="file-list" data-drag-placeholder="请拖拽文件到此处" data-drop-placeholder="请拖拽文件到此处"></div><button type="button" class="btn ' +
				...
				upbtn,
			'lg-list': '<div class="uploader-message text-center"><div class="krt-up-content"></div><button type="button" class="close">×</button></div><div class="uploader-files file-list file-list-lg" data-drag-placeholder="请拖拽文件到此处"></div><div class="uploader-actions"><div class="uploader-status pull-right text-muted"></div><button type="button" class="btn ' +
				...
				' uploader-btn-start"><i class="'+(startBtnIcon?startBtnIcon:'icon icon-cloud-upload')+'"></i> ' + (startBtnText ? startBtnText : '开始上传') +
				'</button></div>',
			'grid-list': '<div class="uploader-message text-center"><div class="krt-up-content"></div><button type="button" class="close">×</button></div><div class="uploader-files file-list file-list-grid"  data-drag-placeholder="请拖拽文件到此处"></div><div class="uploader-actions"><div class="uploader-status pull-right text-muted"></div><button type="button" class="btn ' +
				(browseBtnClass ? browseBtnClass : 'btn-link') + ' uploader-btn-browse"  id="' + id +
				'_browse"><i class="'+(browseBtnIcon?browseBtnIcon:'icon icon-plus')+'"></i> ' + (browseBtnText ? browseBtnText : '选择文件') +
				'</button><button type="button" class="btn ' + (startBtnClass ? startBtnClass : 'btn-link') +
				' uploader-btn-start"><i class="'+(startBtnIcon?startBtnIcon:'icon icon-cloud-upload')+'"></i> ' + (startBtnText ? startBtnText : '开始上传') +
