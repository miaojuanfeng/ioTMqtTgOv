...
JNIEXPORT jint JNICALL Java_com_krt_gov_ir_core_IRDecode_irOpen (JNIEnv *env, jobject this_obj, jobject log_obj, jint category_id, jint sub_cate, jstring file_name)
{
...
JNIEXPORT jint JNICALL Java_com_krt_gov_ir_core_IRDecode_irOpenBinary
...
JNIEXPORT jintArray JNICALL Java_com_krt_gov_ir_core_IRDecode_irDecode (JNIEnv *env, jobject this_obj, jobject log_obj, jint key_code, jobject jni_ac_status, jint change_wind_direction)
{
...
JNIEXPORT jobject JNICALL Java_com_krt_gov_ir_core_IRDecode_mqttEncode (JNIEnv *env, jobject this_obj, jobject log_obj, jintArray code)
{
	...
	jclass cls_ircode = (*env)->FindClass(env, "com/krt/gov/ir/entity/IRCode");
