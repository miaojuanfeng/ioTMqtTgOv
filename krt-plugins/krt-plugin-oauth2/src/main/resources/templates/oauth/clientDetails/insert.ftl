                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="clientId" id="clientId" value="${clientId!}" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="clientSecret" id="clientSecret" value="${clientSecret!}" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
